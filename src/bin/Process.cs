// Dafny program Process.dfy compiled into C#
...
// Command Line Options: /home/alexis51151/Ecole/Rice University/COMP-517/comp517-project/src/dafny/Process.dfy /verifyAllModules /spillTargetCode:1 /compile:3 /out:bin/Process
// Process.dfy
...
class Endokernel {
  ...
  method createEndoprocess(capability: Capability, instruction: string) returns (endoprocess: Endoprocess)
    modifies this
  ...
  method trap(instruction: string)
    modifies this
...
namespace _module {
  ...
  public partial class Endokernel {
    public Endokernel() {
      ...
      this.instructionMap = Dafny.Map<Dafny.ISequence<char>, Capability>.Empty;
    ...
    public Dafny.IMap<Dafny.ISequence<char>,Capability> instructionMap;
    public BigInteger nextPid;
    public Kernel kernel;
    public Endoprocess createEndoprocess(Capability capability, Dafny.ISequence<char> instruction)
    {
    ...
    public void trap(Dafny.ISequence<char> instruction)
    {
      if (!(this.instructionMap).Contains((instruction))) {
        ...
        Capability _54_capability;
        _54_capability = Dafny.Map<Dafny.ISequence<char>, Capability>.Select(this.instructionMap,instruction);
        Endoprocess _55_endoprocess = default(Endoprocess);
        if (!(this.capabilities).Contains((_54_capability))) {
          Endoprocess _out0;
          _out0 = (this).createEndoprocess(_54_capability, instruction);
          _55_endoprocess = _out0;
        } else {
          _55_endoprocess = Dafny.Map<Capability, Endoprocess>.Select(this.capabilities,_54_capability);
        }
        Dafny.Helpers.Print(Dafny.Sequence<char>.Concat(Dafny.Sequence<char>.Concat(Dafny.Sequence<char>.FromString("Trapping instruction "), instruction), Dafny.Sequence<char>.FromString(" from Process in Endokernel\n")));
        (_55_endoprocess).exec(instruction);
      }
    }
    public void trapEndoprocess(Dafny.ISequence<char> instruction, BigInteger endoId)
    {
      if (!(this.instructionMap).Contains((instruction))) {
        Dafny.Helpers.Print(Dafny.Sequence<char>.FromString("trapEndoprocess error: no policy for this instruction\n"));
      } else {
        Capability _56_capability;
        _56_capability = Dafny.Map<Dafny.ISequence<char>, Capability>.Select(this.instructionMap,instruction);
        if (!(this.capabilities).Contains((_56_capability))) {
          ...
          Endoprocess _57_endoprocessExpected;
          _57_endoprocessExpected = Dafny.Map<Capability, Endoprocess>.Select(this.capabilities,_56_capability);
          if (!(this.endoprocesses).Contains((endoId))) {
            ...
            Endoprocess _58_endoprocessTrapped;
            _58_endoprocessTrapped = Dafny.Map<BigInteger, Endoprocess>.Select(this.endoprocesses,endoId);
            if ((_58_endoprocessTrapped) != (object) (_57_endoprocessExpected)) {
              Dafny.Helpers.Print(Dafny.Sequence<char>.FromString("trapEndoprocess error: unknown endoprocess\n"));
            } else {
              Dafny.Helpers.Print(Dafny.Sequence<char>.Concat(Dafny.Sequence<char>.Concat(Dafny.Sequence<char>.FromString("Trapping back instruction "), instruction), Dafny.Sequence<char>.FromString(" from Endoprocess in Endokernel\n")));
    ...
    public void __ctor(Kernel kernel)
    {
      ...
      Capability _59_capability;
      Capability _nw1 = new Capability();
      _nw1.__ctor();
      _59_capability = _nw1;
      (this).instructionMap = Dafny.Map<Dafny.ISequence<char>, Capability>.FromElements(new Dafny.Pair<Dafny.ISequence<char>, Capability>(Dafny.Sequence<char>.FromString("write(0,a)"), _59_capability));
      (this).kernel = kernel;
    }
  }
  ...
  public partial class Endoprocess {
    public Endoprocess() {
      ...
      this.memorySpace = Dafny.Sequence<BigInteger>.Empty;
      this.instructions = Dafny.Sequence<char>.Empty;
      this.endokernel = default(Endokernel);
    }
    public BigInteger id;
    public Dafny.ISequence<BigInteger> memorySpace;
    public Dafny.ISequence<char> instructions;
    public Endokernel endokernel;
    public void __ctor(BigInteger id, Dafny.ISequence<BigInteger> memorySpace, Dafny.ISequence<char> instructions, Endokernel endokernel)
    {
      (this).id = id;
      (this).memorySpace = memorySpace;
      (this).instructions = instructions;
    ...
    public void exec(Dafny.ISequence<char> instruction)
    {
      Dafny.Helpers.Print(Dafny.Sequence<char>.Concat(Dafny.Sequence<char>.Concat(Dafny.Sequence<char>.FromString("Executing instruction "), instruction), Dafny.Sequence<char>.FromString(" in Endoprocess\n")));
  ...
  public partial class Thread {
    public Thread() {
      ...
      this.instructions = Dafny.Sequence<Dafny.ISequence<char>>.Empty;
      this.endokernel = default(Endokernel);
    }
    public BigInteger tid;
    public BigInteger pc;
    public BigInteger sp;
    public Dafny.ISequence<Dafny.ISequence<char>> instructions;
    public Endokernel endokernel;
    public void __ctor(BigInteger tid, BigInteger pc, BigInteger sp, Dafny.ISequence<Dafny.ISequence<char>> instructions, Endokernel endokernel)
    {
      (this).tid = tid;
      (this).pc = pc;
      (this).sp = sp;
    ...
    public void exec()
    {
      if (((this.pc).Sign != -1) && ((this.pc) < (new BigInteger((this.instructions).Count)))) {
        Dafny.Helpers.Print(Dafny.Sequence<char>.Concat(Dafny.Sequence<char>.Concat(Dafny.Sequence<char>.FromString("Executing instruction "), (this.instructions).Select(this.pc)), Dafny.Sequence<char>.FromString(" in Process\n")));
  ...
  public partial class Kernel {
    ...
    public void exec(Dafny.ISequence<char> instruction)
    {
      Dafny.Helpers.Print(Dafny.Sequence<char>.Concat(Dafny.Sequence<char>.Concat(Dafny.Sequence<char>.FromString("Executing instruction "), instruction), Dafny.Sequence<char>.FromString(" in kernel\n")));
    }
    public void __ctor()
    {
    }
